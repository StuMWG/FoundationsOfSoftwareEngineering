...
public class GUI extends JFrame {
    ...
    private JPanel leftPanel = new JPanel(new GridLayout(8, 1));
    private JPanel rightPanel = new JPanel(new GridLayout(8, 1));
    ...
    public GUI(Board board) {
        ...
        // Set up action listener for Blue Computer selection
        getBlueComputer().addActionListener(e -> {
            isBlueComputerEnabled = getBlueComputer().isSelected();
        });
        
        getBlueHuman().addActionListener(e -> {
        	isBlueComputerEnabled = !isBlueComputerEnabled;
        });

        // Set up action listener for Red Computer selection
        getRedComputer().addActionListener(e -> {
            isRedComputerEnabled = getRedComputer().isSelected();
        });
        
        getRedHuman().addActionListener(e -> {
        	isRedComputerEnabled = !isRedComputerEnabled;
        });
    ...
    public boolean isBlueComputerEnabled() {
        return isBlueComputerEnabled;
    }

    public boolean isRedComputerEnabled() {
        return isRedComputerEnabled;
    }
